...
export const Items = [
  ...
  { label: "plumbing", imgUrl: plumbing },
  { label: "pet care", imgUrl: dog },
  { label: "electrical", imgUrl: electrity },
  { label: "Appliance repair", imgUrl: ApplianceRepair },
  { label: "car service", imgUrl: carService },
  { label: "renovation", imgUrl: renovation },
  { label: "learning", imgUrl: learning },
];
